    ...
    // </div>
      ...
      <div className="card modern-card">
        ...
        <div className="card-header d-flex justify-content-between align-items-center">
          <h5 className="mb-0 fw-bold">{item.Segment}</h5>
          <button
            className="btn btn-outline-primary btn-sm rounded-pill"
            onClick={() => handleSignal(item.Segment)}
          >
            View Signal
          </button>
        </div>
        ...
        <div className="card-body">
          <Formik
            ...
            onSubmit={(values) => {
              ...
              updatedData[index].ExitDay = values.tradeMode;
              updatedData[index].StrategyTag = values.strategyTags || [];
              setChartingData(updatedData);
              handleAddCharting(index);
            }}
          >
              ...
              <Form>
                ...
                <div className="d-flex justify-content-between mb-3">
                  <div className="form-check form-switch">
                    ...
                    <label className="form-check-label ms-2">Trade Status</label>
                  </div>
                  ...
                  {adminPermission?.includes("Admin Signal") && (
                    <div className="form-check form-switch">
                      ...
                      <label className="form-check-label ms-2">Admin Signal</label>
                    </div>
                  )}
                </div>
                ...
                <div className="row g-3 mb-3">
                  ...
                  <div className="col-6">
                    <label className="form-label">Trade/Day</label>
                    <Field
                      name="tradePerDay"
                      type="number"
                      className="form-control modern-input"
                ...
                <div className="row g-3 mb-3">
                  <div className="col-6">
                    <label className="form-label">Max Profit</label>
                    <Field
                      name="maxProfit"
                      type="number"
                      className="form-control modern-input"
                ...
                {/* Running Trade */}
                <div className="mb-3">
                  <label className="form-label">Running Trade</label>
                  <Field
                    name="runningTrade"
                    type="number"
                    className="form-control modern-input"
                ...
                <div className="mb-3">
                  ...
                  <Select
                    ...
                    options={() => {
                      if (
                        values.strategyTags.length === baseOptions.length &&
                    ...
                    value={baseOptions.filter((opt) =>
                      values.strategyTags.includes(opt.value)
                    )}
                    onMenuOpen={() => setMenuOpen(true)}
                    onMenuClose={() => setMenuOpen(false)}
                    onChange={(selectedOptions) => {
                      ...
                      if (
                        selectedOptions.some(
                          (opt) => opt.value === "__deselect_all__"
                        )
                      ) {
                        setFieldValue("strategyTags", []);
                        return;
                      ...
                      setFieldValue(
                        ...
                        selectedOptions
                          .filter(
                            (opt) =>
                              opt.value !== "__select_all__" &&
                              opt.value !== "__deselect_all__"
                          )
                          .map((opt) => opt.value)
                      );
                    }}
                ...
                {/* Save Changes */}
                <button type="submit" className="btn modern-btn w-100">
                  Save Changes
                </button>
              </Form>
            )}
