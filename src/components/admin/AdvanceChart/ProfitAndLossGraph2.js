...
export default function ProfitAndLossGraph2({ data = [], valueFormatter }) {
    ...
    const chartSetting = {
        ...
        series: [{ dataKey: 'PnL', label: 'PnL', valueFormatter: formatter }],
        height: 300,
    };
    ...
    return (
        <div style={{ width: '100%' }}>
            ...
            <BarChart
                dataset={chartData}
                xAxis={[{ dataKey: 'Symbol', tickPlacement, tickLabelPlacement }]}
                {...chartSetting}
            />
        </div>
    );
